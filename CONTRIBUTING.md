Contributing to DIRTYDEEDS Core
============================

The DIRTYDEEDS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DIRTYDEEDS Core project, and is not to be
confused with overall DIRTYDEEDS Network Protocol consensus changes.

Whether a pull request is merged into DIRTYDEEDS Core rests with the project merge
...
Patches that change DIRTYDEEDS consensus rules are considerably more involved than
...
Where a patch set proposes to change the DIRTYDEEDS consensus, it must have been
...
The project leader is the release manager for each DIRTYDEEDS Core release.

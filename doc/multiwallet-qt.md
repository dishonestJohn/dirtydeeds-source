...
In order to support loading of multiple wallets in dirtydeeds-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dirtydeeds.cpp.
...
Changes to dirtydeeds.cpp
----------------------
dirtydeeds.cpp is the entry point into dirtydeeds-qt, and as such, will require some minor modifications to provide hooks for

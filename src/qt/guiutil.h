...
/** Utility functions used by the DIRTYDEEDS Qt UI.
 */
namespace GUIUtil
{
...
// Render DIRTYDEEDS addresses in monospace font
...
// Parse "dirtydeeds:" URI into recipient object, return true on successful parsing

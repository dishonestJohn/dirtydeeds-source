                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzDIDPathCustom = GetArg("-zdidbackuppath", "");
    ...
    if(!strzDIDPathCustom.empty()) {
        ui->wallet_customzdidbackuppath->setText(QString::fromStdString(strzDIDPathCustom));
        ui->wallet_customzdidbackuppath_label->setVisible(true);
        ui->wallet_customzdidbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzDIDPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the DIRTYDEEDS RPC console.") + "<br>" +

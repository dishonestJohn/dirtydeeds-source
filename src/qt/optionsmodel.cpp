...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::DID);
    ...
    if (!settings.contains("nAnonymizeDIRTYDEEDSAmount"))
        settings.setValue("nAnonymizeDIRTYDEEDSAmount", 1000);

    nAnonymizeDIRTYDEEDSAmount = settings.value("nAnonymizeDIRTYDEEDSAmount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizeDIRTYDEEDSAmount"))
        SoftSetArg("-anonymizedirtydeedsamount", settings.value("nAnonymizeDIRTYDEEDSAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in dirtydeeds.cpp during shotdown to also remove the window positions
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case AnonymizeDIRTYDEEDSAmount:
            return QVariant(nAnonymizeDIRTYDEEDSAmount);
        case Listen:
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case AnonymizeDIRTYDEEDSAmount:
            nAnonymizeDIRTYDEEDSAmount = value.toInt();
            settings.setValue("nAnonymizeDIRTYDEEDSAmount", nAnonymizeDIRTYDEEDSAmount);
            emit anonymizeDIRTYDEEDSAmountChanged(nAnonymizeDIRTYDEEDSAmount);
            break;
        case CoinControlFeatures:

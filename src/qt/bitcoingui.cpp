                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DIRTYDEEDS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DIRTYDEEDS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dirtydeeds: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDID"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DIRTYDEEDS Core"), this);
    aboutAction->setStatusTip(tr("Show information about DIRTYDEEDS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DIRTYDEEDS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DIRTYDEEDS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DIRTYDEEDS addresses"));
    ...
    openAction->setStatusTip(tr("Open a DIRTYDEEDS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DIRTYDEEDS Core help message to get a list with possible DIRTYDEEDS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DIRTYDEEDS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DIRTYDEEDS network", "", count));
}
...
{
    QString strTitle = tr("DIRTYDEEDS Core"); // default title

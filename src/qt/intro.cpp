...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DIRTYDEEDS Core"),
     ...
     * override -datadir in the dirtydeeds.conf file in the default data directory
     * (to be consistent with dirtydeedsd behavior)
     */
    if (dataDir != getDefaultDataDirectory())

...
/* DIRTYDEEDS GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DIRTYDEEDS"
#define QAPP_ORG_DOMAIN "dirtydeeds.org"
#define QAPP_APP_NAME_DEFAULT "DIRTYDEEDS-Qt"
#define QAPP_APP_NAME_TESTNET "DIRTYDEEDS-Qt-testnet"

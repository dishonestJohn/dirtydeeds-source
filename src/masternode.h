...
#define MASTERNODE_MIN_CONFIRMATIONS 18
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 DID, signature to prove

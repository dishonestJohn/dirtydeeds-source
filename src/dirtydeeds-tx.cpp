...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DIRTYDEEDS Core dirtydeeds-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dirtydeeds-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dirtydeeds transaction") + "\n" +
                               "  dirtydeeds-tx [options] -create [commands]   " + _("Create hex-encoded dirtydeeds transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dirtydeeds transaction

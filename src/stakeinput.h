...
#ifndef DIRTYDEEDS_STAKEINPUT_H
#define DIRTYDEEDS_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZDID() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zDIDStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zdid, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZDID() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZDID() override { return false; }
};


#endif //DIRTYDEEDS_STAKEINPUT_H

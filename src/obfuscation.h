...
{
public:
    /// Is the inputs associated with this public key? (and there is 3600 DID - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of dirtydeeds.

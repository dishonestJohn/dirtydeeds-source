...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop DIRTYDEEDS server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "DIRTYDEEDS server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DIRTYDEEDS features */
        {"dirtydeeds", "masternode", &masternode, true, true, false},
        {"dirtydeeds", "listmasternodes", &listmasternodes, true, true, false},
        {"dirtydeeds", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dirtydeeds", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dirtydeeds", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"dirtydeeds", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"dirtydeeds", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"dirtydeeds", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dirtydeeds", "masternodedebug", &masternodedebug, true, true, false},
        {"dirtydeeds", "startmasternode", &startmasternode, true, true, false},
        {"dirtydeeds", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dirtydeeds", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dirtydeeds", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dirtydeeds", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dirtydeeds", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dirtydeeds", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dirtydeeds", "mnbudget", &mnbudget, true, true, false},
        {"dirtydeeds", "preparebudget", &preparebudget, true, true, false},
        {"dirtydeeds", "submitbudget", &submitbudget, true, true, false},
        {"dirtydeeds", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dirtydeeds", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dirtydeeds", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dirtydeeds", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dirtydeeds", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dirtydeeds", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dirtydeeds", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dirtydeeds", "checkbudgets", &checkbudgets, true, true, false},
        {"dirtydeeds", "mnsync", &mnsync, true, true, false},
        {"dirtydeeds", "spork", &spork, true, true, false},
        {"dirtydeeds", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzdidseed", &getzdidseed, false, false, true},
        {"zerocoin", "setzdidseed", &setzdidseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzdid", &searchdzdid, false, false, true},
        {"zerocoin", "dzdidstate", &dzdidstate, false, false, true}
...
{
    return "> dirtydeeds-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5779/\n";
}

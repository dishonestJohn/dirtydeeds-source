...
/**
 * DIRTYDEEDS RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzdidseed(const UniValue& params, bool fHelp);
extern UniValue getzdidseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzdid(const UniValue& params, bool fHelp);
extern UniValue dzdidstate(const UniValue& params, bool fHelp);

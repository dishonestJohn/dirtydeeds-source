...
#   c) node1 mines 32 blocks, so now node 0 has 60001did, node 1 has 4250did, node2 has none.
#   d) node0 sends 601 did to node2, in two transactions (301 did, then 300 did).
